...
(async () => {
  ...
  function bufferGavel() {
    ...
    buffered.src = '/gavel.mp4#t=1.8,4';
  ...
  function mountGavel(atStrike) {
    ...
    if (!buffered) { v.src = '/gavel.mp4#t=1.8,4'; v.muted = true; v.playsInline = true; }
    ...
    const IMPACT = 3.18, FADE_AT = 4.0; // measured by hand on the tuning page, 2026-09-01: start 1.80 (amended from 2.20 for more wind-up), impact 3.18, end 4.00 (amended from 4.63 by eye)
